...
.definelabel style1Mtx, 0x807FFF40 // 0x20
...
.defineLabel songArray, 0x80745BDC ;0x4 struct
.defineLabel LevelIndexes, 0x807445E0 ; u8 array
.defineLabel CollectableFlagTable, 0x80755A20 ; 0x8 struct array

; Hack data
; Menu Stuff
.defineLabel menuCutsceneTimer, 0x80033F53;
.defineLabel menuCutsceneIndex, 0x80033F54;
.defineLabel menuDKyPos, 0x8003369C;
.defineLabel menuCameraHeight, 0x80033678;
.defineLabel isInSubmenu, 0x800337F8;
.defineLabel menuIntroCS, 0x80033734;

; Loading Zones
.definelabel loadingZoneArray, 0x807FDCB4
.definelabel loadingZoneArraySize, 0x807FDCB0