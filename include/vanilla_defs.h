...
extern songStruct songArray[0xC0];
extern u8 LevelIndexes[0xDC];
extern CollectableFlagStruct CollectableFlagTable[113];

//Menu Stuff
extern unsigned char menuCutsceneTimer;
extern unsigned char menuCutsceneIndex;
extern float menuDKyPos;
extern float menuCameraHeight;
extern char isInSubmenu;
extern char menuIntroCS;

//Loading Zones
extern LoadingZone *loadingZoneArray;
extern unsigned short loadingZoneArraySize;
