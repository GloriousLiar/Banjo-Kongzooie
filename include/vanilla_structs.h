...
typedef struct CollectableFlagStruct {
	/* 0x000 */ u8 map;
	/* 0x001 */ u8 unk1;
	/* 0x002 */ u16 model2_id;
	/* 0x004 */ u16 flag_index;
	/* 0x006 */ u8 collectable_state;
	/* 0x007 */ u8 slot_used;
} CollectableFlagStruct;
...
typedef struct playerData {
	...
	/* 0x0C0 */ f32 yVelocity;
	/* 0x0C4 */ f32 yAccel;
	/* 0x0C8 */ s8 unk_C8[0xE0 - 0xC8];
	/* 0x0E0 */ f32 slipping_speed;
	/* 0x0E4 */ s8 unk_E4[0xE6 - 0xE4];
...
typedef struct LoadingZone { //size: 0x3A
    /* 0x00 */short xpos;
    /* 0x02 */short ypos;
    /* 0x04 */short zpos;
    /* 0x06 */unsigned short radius;
    /* 0x08 */unsigned short height;
    /* 0x0A */unsigned short unkA;
    /* 0x0C */char activation_type; //0xC
    /* 0x0D */char pad0[0x10 - 0xD];
    /* 0x10 */unsigned short object_type;
    /* 0x12 */unsigned short dest_map;
    /* 0x14 */unsigned short dest_exit;
    /* 0x16 */unsigned short transition_type;
    /* 0x18 */short unk18;
    /* 0x1A */unsigned short cutscene_is_tied;
    /* 0x1C */unsigned short cutscene_activated;
    /* 0x1E */unsigned short shift_camera_to_kong; //0x1E
    /* 0x20 */char pad1[0x38 - 0x20];
    /* 0x38 */char not_in_zone;
    /* 0x39 */char active;
} LoadingZone;